...
while true; do
    ...
    if [ "$ac_adapter" == "off" ]; then
	    ...
	    play sounds/mixkit-wrong-answer-fail-notification-946.wav
            # break
            # sleep 180
	    ...
	    # To get the sound notification
	    play sounds/mixkit-bell-notification-933.wav
            # break
            sleep 200
	    ...
	    # To get the sound notification
	    play sounds/mixkit-melodical-flute-music-notification-2310.wav
